...
const Social = () => {
    return (
        <div className='mt-4 flex gap-4'>
            ...
            <a href="https://www.linkedin.com/in/mafizul-islam-mern/"><img className='h-12 w-12 border-2 border-gray-700 p-2 rounded-full hover:bg-yellow-500 hover:border-yellow-600' src={linkedin} alt='LinkeDin' /></a>
            ...
            <a href="mailto:mafizul24h@gmail.com"><img className='h-12 w-12 border-2 border-gray-700 p-2 rounded-full hover:bg-yellow-500 hover:border-yellow-600' src={email} alt='Email' /></a>
            ...
            <a href="https://wa.me/+8801912007697"><img className='h-12 w-12 border-2 border-gray-700 p-2 rounded-full hover:bg-yellow-500 hover:border-yellow-600' src={whatsApp} alt='Phone' /></a>
        </div>
    );
};
