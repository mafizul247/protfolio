...
const Banner = () => {
    return (
        <section id='home' className='pt-24 py-12 mx-4 md:mx-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center bg-slate-100 px-4 md:px-12 shadow-lg'>
            <div className='text-gray-800 order-2 md:order-1'>
                <p className='text-4xl sm:text-5xl font-bold'>Hi, I'm </p>
                ...
                <p className='text-2xl sm:text-3xl text-red-500 font-bold my-3'>Full Stack Web Developer (MERN)</p>
            ...
            <div className='order-1 md:order-2 flex justify-center'>
                <img
                    ...
                    src={image}
                    alt='Mafizul Islam, Full Stack Web Developer'
                />
            </div>
        </section>
    );
